 ...
 *{box-sizing:border-box}
 ...
 #tabs{max-width:1180px;margin:0 auto;padding:14px 16px 0;display:flex;gap:6px;flex-wrap:wrap}
 .tab{background:var(--card);color:var(--mut);border:1px solid var(--bd);border-bottom:none;
   border-radius:8px 8px 0 0;padding:8px 16px;cursor:pointer;font:600 14px inherit;display:flex;align-items:center;gap:8px}
 .tab.active{background:var(--card2);color:var(--fg)}
 .tab .tbadge{font-size:10px;padding:1px 7px;border-radius:20px}
</style></head><body>
